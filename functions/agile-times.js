...
function addTimesheet(intent, session, callback) {
    ...
    if (projectSlot && typeof(projectSlot.value) !== 'undefined') {
        ...
        speechOutput = categorySlot && typeof(categorySlot.value) !== 'undefined' ? `Got it Tejprakash. Adding new timesheet to ${project} project, ${category} category.` : `Got it Tejprakash. Adding new timesheet to ${project} project.`;
    } else {
